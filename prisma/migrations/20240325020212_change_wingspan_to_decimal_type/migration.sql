/*
  ...
  - You are about to alter the column `wingspan` on the `Jet` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Decimal`.

...
// import { JetNames } from '../types/interfaces';

// const ComparisonForm: React.FC<JetNames> = ({ jetNames }): JSX.Element => {
//   const [selectedSearchTerm, setSelectedSearchTerm] = useState<string>('Top Speed');
...
//           <option value="Fuel Efficieny">Fuel Efficieny</option>
